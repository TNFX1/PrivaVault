<div align="center">
  ...
  <p>
    ...
    <a href="#-installation--usage"><img src="https://img.shields.io/badge/Platform-Windows-0078D6?style=for-the-badge&logo=windows" alt="Platform"></a>
...
**PrivaVault** is an advanced, desktop-native Windows file encryption tool engineered with **Electron** and **Node.js stream processing**. It enables users to bundle, encrypt, inspect, and extract single or multiple files locally with absolute privacy and zero-knowledge guarantee.
...
- **Native Windows Optimization:** Engineered specifically for Windows desktop environments with dedicated Installers and Portable executables.
...
| 🪟 **Windows Native** | **NSIS & Portable** | Native support for Windows Setup Installers (`.exe`) and single-file Portable executables. |
...
Visit the **[Releases](https://github.com/TNFX1/PrivaVault/releases)** section to download the latest Windows build.

### 🪟 Windows Executables
- `PrivaVault-Setup-1.4.0.exe` *(Standard Windows Installer – Double click to install)*
- `PrivaVault-Portable-1.4.0.exe` *(Portable Executable – Double click to run immediately without installation)*

---

### 🛠️ Build from Source

Requirements: **Windows OS**, **Node.js v18+** & **npm**
